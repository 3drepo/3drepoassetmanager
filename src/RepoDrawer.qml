...
//                camera.tagCodeDetected.connect(relay)
        ...
        model: ListModel {
            // https://bugreports.qt.io/browse/QTBUG-50598
            ListElement { title: qsTr("Camera"); icon: "image://materialicons/camera"; source: "qrc:/src/RepoCameraPage.qml" }
            ListElement { title: qsTr("Drawing"); icon: "image://materialicons/assignment"; source: "qrc:/src/RepoDrawing.qml"}
        }
