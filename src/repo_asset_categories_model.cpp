...
{
    QString path("c:\\Users\\jozef\\Documents\\3D Models\\BB\\Crossrail\\Exports\\C530-001-UF-006-UPDDAT-01\\");
    QDir directory(path);

    QStringList fileNames = directory.entryList(QStringList("*.csv"), QDir::Files);
